...
- (void)setupMenuContainerView {
    ...
    self.menuContainerView.autoresizingMask =	UIViewAutoresizingFlexibleHeight |
												UIViewAutoresizingFlexibleWidth;
	NSLog(@"menu container frame : %@", NSStringFromCGRect(self.menuContainerView.frame));
...
- (void) setLeftSideMenuFrameToClosedPosition {
	...
	// commented by kevin for ipad to display language list
    /*CGRect leftFrame = [self.leftMenuViewController view].frame;
